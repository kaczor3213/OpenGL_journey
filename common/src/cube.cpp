...
////////
	...
	coordinates[0].set_color(COLOR_RED) ;
	coordinates[1].set_color(COLOR_RED);
	coordinates[2].set_color(COLOR_RED);
	coordinates[3].set_color(COLOR_RED);
										
	coordinates[4].set_color(COLOR_RED)	;
	coordinates[5].set_color(COLOR_RED)	;
	coordinates[6].set_color(COLOR_RED)	;
	coordinates[7].set_color(COLOR_RED)	;
										
	coordinates[8].set_color(COLOR_RED)	;
	coordinates[9].set_color(COLOR_RED)	;
	coordinates[10].set_color(COLOR_RED);
	coordinates[11].set_color(COLOR_RED);
										
	coordinates[12].set_color(COLOR_RED);
	coordinates[13].set_color(COLOR_RED);
	coordinates[14].set_color(COLOR_RED);
	coordinates[15].set_color(COLOR_RED);
										
	coordinates[16].set_color(COLOR_RED);
	coordinates[17].set_color(COLOR_RED);
	coordinates[18].set_color(COLOR_RED);
	coordinates[19].set_color(COLOR_RED);
										
	coordinates[20].set_color(COLOR_RED);
	coordinates[21].set_color(COLOR_RED);
	coordinates[22].set_color(COLOR_RED);
	coordinates[23].set_color(COLOR_RED);
										
	coordinates[24].set_color(COLOR_RED);
	coordinates[25].set_color(COLOR_RED);
	coordinates[26].set_color(COLOR_RED);
	coordinates[27].set_color(COLOR_RED);
										
	coordinates[28].set_color(COLOR_RED);
	coordinates[29].set_color(COLOR_RED);
	coordinates[30].set_color(COLOR_RED);
	coordinates[31].set_color(COLOR_RED);
										
	coordinates[32].set_color(COLOR_RED);
	coordinates[33].set_color(COLOR_RED);
	coordinates[34].set_color(COLOR_RED);
	coordinates[35].set_color(COLOR_RED);
}

/*
void cube::buff_handle()
{
